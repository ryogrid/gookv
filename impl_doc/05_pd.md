...
| `ReportBatchSplit` | Unary | Records all post-split regions into MetadataStore, setting the first peer of each region as the leader (the caller is the leader that executed the split). |
